...
private slots:
    ...
    void show_menu(AlpmPackage * pkg,const QModelIndex & index,const QRect & rect,PacmanView * view);
    void item_selected(const QItemSelection & selected,PacmanView * view);

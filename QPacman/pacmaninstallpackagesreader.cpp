...
PacmanInstallPackagesReader::PacmanInstallPackagesReader(const QString & su_password,const QString & packages,QObject *parent) : PacmanProcessReader(su_password,parent) {

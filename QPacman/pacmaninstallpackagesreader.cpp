...
PacmanInstallPackagesReader::PacmanInstallPackagesReader(const QString & packages,QObject *parent) : PacmanProcessReader(parent) {
    ...
    connect(PacmanServerInterface::instance(),SIGNAL(ready_to_process_install(const QStringList &,const QStringList &,const QStringList &,qreal,qreal)),this,SLOT(on_readyToProcess(const QStringList &,const QStringList &,const QStringList &,qreal,qreal)));
...
void PacmanInstallPackagesReader::on_readyToProcess(const QStringList & install_packages,const QStringList & remove_packages,const QStringList & /*local_install_packages*/,qreal total_installed, qreal total_removed) {

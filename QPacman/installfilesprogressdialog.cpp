...
InstallFilesProgressDialog::InstallFilesProgressDialog(const QStringList & packages,QWidget *parent) : InstallProgressDialog(parent) {
...
int InstallFilesProgressDialog::packages_count() {
    return InstallProgressDialog::packages_count() + ((PacmanInstallLocalPackagesReader*)installer)->local_install_packages().count();
}
